	...
	// Iterate over list items and add 'mouseover' and 'mouseout' event listeners
	listItems.forEach(function(item) {
		
		// 'mouseover': Remove 'no-hover' class and add 'hover' class
		item.addEventListener('mouseover', function() {
			this.classList.remove('no-hover');
			this.classList.add('hover');
		});

		// 'mouseout': Remove 'hover' class and add 'no-hover' class
